        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-blue-800 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-blue-800">
                    ...
                    <li>
                        <a href="table_supplier.php" class="block py-2 text-blue-300 rounded bg-transparent" aria-current="page">Supplier</a>
                    </li>
                    <li>
                    ...
                    <div class="p-6 space-y-6">
                        <form action="supplier/tambah.php" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" name="alamat" class="bg-white border border-black text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukan Alamat" autocomplete="off" required></textarea>
                            </div>
                            <div class="mb-3">
                                <label class="block mb-2 text-md font-medium text-black">Email</label>
                                <input type="email" name="email" class="bg-white border border-black text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukan Email" autocomplete="off" required>
                            </div>
                            <div class="mb-3">
                    ...
                    ?>
                        <tr class="bg-white border-b">
                            ...
                            <td class="px-6 py-4">
                                        ...
                                        <div class="relative bg-white rounded-xl shadow">
                                            ...
                                            <div class="p-6 space-y-6">
                                                <form action="supplier/update.php" method="post">
                                                    <input type="hidden" name="id" value="<?= $data['id_suplier'] ?>">
                                                    <div class="mb-3">
                                                        <label class="block mb-2 text-md font-medium text-black">Nama</label>
                                                        <input type="text" name="nama" value="<?= $data['nama_sp'] ?>" class="bg-white border border-black text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukan Nama" autocomplete="off" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="block mb-2 text-md font-medium text-black">Alamat</label>
                                                        <textarea type="text" name="alamat" class="bg-white border border-black text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukan Alamat" autocomplete="off" required><?= $data['alamat'] ?></textarea>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="block mb-2 text-md font-medium text-black">Email</label>
                                                        <input type="email" name="email" value="<?= $data['email'] ?>" class="bg-white border border-black text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukan Email" autocomplete="off">
                                                    </div>
                                                    <div class="mb-3">
                                                        <button type="submit" name="simpan" class="text-white bg-blue-800 hover:bg-blue-900 font-medium rounded-lg text-sm w-full px-5 py-2.5">Simpan</button>
                                                    </div>
                                ...
                                <a href="supplier/delete.php?id=<?= $data['id_suplier'] ?>" class="font-medium text-red-600" onclick="return confirm('Apakah kamu yakin?')">Hapus</a>
                            </td>
                        </tr>
                    <?php $no++;
                    } ?>
